...
<body>
    <div class="page-main padbot100">        
        ...
        <div class="bottom-cont">
            ...
            <p class="price"><span>￥</span><span id='pay_price'><?php echo $album['price']?></span></p>
        </div>
	...
	var album_id = <?php echo $album['id']?>;
        seajs.use([
           '<?php echo css_js_url('pay_all_image.js', 'wap')?>',
        ], function(pay_all_image){
          	pay_all_image.load();
          	pay_all_image.address();
          	pay_all_image.payment();
		})
    </script>
