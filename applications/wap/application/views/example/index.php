...
<body>
	<div class="m">
		<video id="my-video" playsinline webkit-playsinline poster="<?php echo $domain['static']['url']?>/wap/images/v1.png" class="video-js my-video1" vjs-fluid controls preload="auto"
		       data-setup="{}">
		       <!--poster="img/v1.png"-->
			<source src="<?php echo get_video_url('20170419/yangpian.mp4')?>" type="video/mp4">
			<source src="<?php echo get_video_url('20170419/yangpian.mp4')?>" type="video/webm">
			<source src="<?php echo get_video_url('20170419/yangpian.mp4')?>" type="video/ogg">
			<p class="vjs-no-js">
    ...
    <div class="main2">
    	...
    	<img src="<?php echo $domain['static']['url']?>/wap/images/f1.png" class="img1"/>
    	<img src="<?php echo $domain['static']['url']?>/wap/images/f4.png" class="img2"/>
    </div>
</body>
