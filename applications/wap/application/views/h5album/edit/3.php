...
<div class="swiper-container">
    ...
    <div class="swiper-wrapper">
        <section class="swiper-slide">
            <ul>
                <li class="ani" style="width: 100%;; height: 90%;; left: 0px; top: 5%;" swiper-animate-effect="zoomIn" swiper-animate-duration="2s" swiper-animate-delay="0s"><img id="p1e1" class="wxuploader" data-group="g1"  src="<?php echo isset($elements['p1e1']) ?  get_img_url($elements['p1e1']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>"  ></li>
                <li class="ani" style="width: 100%;; height: 90%;; left: 0px; top: 5%;" swiper-animate-effect="puffIn" swiper-animate-duration="2s" swiper-animate-delay="0.2s"><img id="p1e2" class="wxuploader" data-group="g1" src="<?php echo isset($elements['p1e2']) ?  get_img_url($elements['p1e2']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>"  ></li>
        ...
        <section class="swiper-slide">   
            <ul>
                <li class="ani" style="width: 100%; height: 98%; left: 0; top: 1%; border: 1px solid rgb(0, 0, 0);" swiper-animate-effect="zoomIn" swiper-animate-duration="2s" swiper-animate-delay="0.2s"><img id="p2e1" class="wxuploader" src="<?php echo isset($elements['p2e1']) ?  get_img_url($elements['p2e1']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>"></li>
        ...
        <section class="swiper-slide">      
            <ul>
                ...
                <li class="ani" style="width: 70%; height: 65%; right: 0; top: 27%; border: 1px solid rgb(0, 0, 0);" swiper-animate-effect="fadeInRight" swiper-animate-duration="2s" swiper-animate-delay="0.2s">
                    ...
                    <img id="p3e1" class="wxuploader" src="<?php echo isset($elements['p3e1']) ?  get_img_url($elements['p3e1']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                ...
                <li class="ani" style="width: 25%; height: 22%; left: 18%; top: 5%; border: 1px solid rgb(0, 0, 0);" swiper-animate-effect="zoomIn" swiper-animate-duration="2s" swiper-animate-delay="1s">
                    ...
                    <img id="p3e2" class="wxuploader" src="<?php echo isset($elements['p3e2']) ?  get_img_url($elements['p3e2']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
        ...
        <section class="swiper-slide">
            <ul>
                <li class="ani" style="width: 100%; height: 80%; left: 0px; top: 15px;" swiper-animate-effect="puffIn" swiper-animate-duration="1s" swiper-animate-delay="0s">
                    ...
                    <img id="p4e1" class="wxuploader" src="<?php echo isset($elements['p4e1']) ?  get_img_url($elements['p4e1']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
        ...
        <section class="swiper-slide">
            <ul>
                ...
                <img id="p5e1" class="wxuploader" src="<?php echo isset($elements['p5e1']) ?  get_img_url($elements['p5e1']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>"">
        ...
        <section class="swiper-slide">
            <ul>
                <li class="ani" style="width: 254px; height: 254px; left: 50%;margin-left: -127px; top: 180px;border-radius: 50%;overflow: hidden;" swiper-animate-effect="fadeInLeft" swiper-animate-duration="2s" swiper-animate-delay="0.2s">
                    ...
                    <img id="p7e1" class="wxuploader" src="<?php echo isset($elements['p7e1']) ?  get_img_url($elements['p7e1']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>"></li>
        ...
        <section class="swiper-slide">
            <ul>
                ...
                <li class="ani" style="width: 100%; height: 45%; left: -1px; top: 20px;border: 1px solid rgb(0, 0, 0);" swiper-animate-effect="puffIn" swiper-animate-duration="2s" swiper-animate-delay="0.2s">
                    ...
                    <img id="p8e1" class="wxuploader" src="<?php echo isset($elements['p8e1']) ?  get_img_url($elements['p8e1']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>"></li>
        ...
        <section class="swiper-slide">
            <ul>
                <li class="ani" style="width: 70%; height: 55%; left: 5px; top: 165px;border: 1px solid rgb(0, 0, 0);" swiper-animate-effect="fadeInLeft" swiper-animate-duration="2s" swiper-animate-delay="0s">
                    ...
                    <img id="p9e1" class="wxuploader" src="<?php echo isset($elements['p9e1']) ?  get_img_url($elements['p9e1']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>"></li>
        ...
        <section class="swiper-slide">
            <ul>
                <li class="ani" style="width: 40%; height: 45%; right: 0px; top: 48%;" swiper-animate-effect="fadeInRight" swiper-animate-duration="2s" swiper-animate-delay="1s">
                    ...
                    <img id="p10e1" class="wxuploader" src="<?php echo isset($elements['p10e1']) ?  get_img_url($elements['p10e1']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                ...
                <li class="ani" style="width: 100%; height: 45%; left: 0px; top: 3%; " swiper-animate-effect="fadeInDown" swiper-animate-duration="2s" swiper-animate-delay="0s">
                    ...
                    <img id="p10e2" class="wxuploader" src="<?php echo isset($elements['p10e2']) ?  get_img_url($elements['p10e2']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>"></li>
        ...
        <section class="swiper-slide">
            <ul>
                ...
                <li class="ani" style="width: 254px; height: 254px; left: 50%;margin-left: -127px; top: 220px; border: 1px solid rgb(0, 0, 0);border-radius: 50%;overflow: hidden;" swiper-animate-effect="fadeInLeft" swiper-animate-duration="2s" swiper-animate-delay="0.2s">
                    ...
                    <img id="p11e1" class="wxuploader" src="<?php echo isset($elements['p11e1']) ?  get_img_url($elements['p11e1']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>"></li>
