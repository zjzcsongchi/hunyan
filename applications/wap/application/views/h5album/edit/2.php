                ...
                <ul class="edit_area weebly-content-area weebly-area-active">
                    <li class="comp-resize comp-rotate inside wsite-image" style="width: 280px; height: 104px; left: 50%;margin-left: -140px; top: 32px; z-index: 2;">
                        <div class="element-box" style="left: 50%;margin-left: -140px;animation: puffIn 1.5s ease 0s 1 both;">
                            <img class="element comp_image editable-image " src="<?php echo isset($elements['p1e1']) ?  get_img_url($elements['p1e1']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                    ...
                    <li class="comp-resize comp-rotate inside wsite-image" style="width: 308px; height: 210px; left: 50%;margin-left: -154px; top: 136px; z-index: 3;">
                        <div class="element-box" style="left: 50%;margin-left: -154px;animation: zoomIn 2s ease 0s 1 both;">
                            <img class="element comp_image editable-image wxuploader" src="<?php echo isset($elements['p1e2']) ?  get_img_url($elements['p1e2']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                    ...
                    <li class="comp-resize comp-rotate inside wsite-image" style="width: 267px; height: 32px; left: 50%;margin-left: -133px; top: 357px; z-index: 4;">
                        <div class="element-box" style="left: 50%;margin-left: -133px;animation: fadeIn 2s ease 1.2s 1 both;">
                            <img class="element comp_image editable-image " src="<?php echo isset($elements['p1e3']) ?  get_img_url($elements['p1e3']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                            <input type="hidden" name="p1e3" value="<?php echo isset($elements['p1e3']) ?  get_img_url($elements['p1e3']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>" />
                        </div>
                    </li>
                    <li class="comp-resize comp-rotate inside wsite-image" style="width: 141px; height: 40px; left: 50%;margin-left: -70px; top: 392px; z-index: 5;">
                        <div class="element-box" style="left: 50%;margin-left: -70px; animation: fadeIn 2s ease 1.8s 1 both;">
                            <img class="element comp_image editable-image " src="<?php echo isset($elements['p1e4']) ?  get_img_url($elements['p1e4']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                            <input type="hidden" name="p1e4" value="<?php echo isset($elements['p1e4']) ?  get_img_url($elements['p1e4']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>" />
                        </div>
                    </li>
                </ul>
            </div>
                ...
                <ul class="edit_area weebly-content-area weebly-area-active">
                    <li class="comp-resize comp-rotate inside wsite-image" style="width: 303px; height: 202px; left: 50%;margin-left: -151px; top: 95px; z-index: 2;">
                        <div class="element-box" style="left: 50%;margin-left: -151px;animation: fadeInLeft 2s ease 0s 1 both;">
                            <img class="element comp_image editable-image wxuploader" src="<?php echo isset($elements['p2e1']) ?  get_img_url($elements['p2e1']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                        ...
                        <li class="comp-resize comp-rotate inside wsite-image" style="width: 303px; height: 202px; left: 50%;margin-left: -151px; top: 320px; z-index: 3;">
                            <div class="element-box" style="left: 50%;margin-left: -151px;animation: fadeInRight 2s ease 0s 1 both;">
                                <img class="element comp_image editable-image wxuploader" src="<?php echo isset($elements['p2e2']) ?  get_img_url($elements['p2e2']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                        ...
                        <li class="comp-resize comp-rotate inside wsite-image" style="width: 130px; height: 50px; left: 50%;margin-left: -65px; top: 35px; z-index: 4;">
                            <div class="element-box" style="left: 50%;margin-left: -65px;animation: fadeInDown 2s ease 1.2s 1 both;">
                                <img class="element comp_image editable-image " src="<?php echo isset($elements['p2e3']) ?  get_img_url($elements['p2e3']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                                <input type="hidden" name="p2e3" value="<?php echo isset($elements['p2e3']) ?  get_img_url($elements['p2e3']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>" />
                            </div>
                        </li>
                </ul>
            </div>
                ...
                <ul class="edit_area weebly-content-area weebly-area-active">
                    <li class="comp-resize comp-rotate inside wsite-image" style="width: 258px; height: 29px; left: 0px; top: 91px; z-index: 2;">
                        <div class="element-box" style="animation: fadeInLeft 3s ease 0s 1 both;">
                            <img class="element comp_image editable-image " src="<?php echo isset($elements['p3e1']) ?  get_img_url($elements['p3e1']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                    ...
                    <li class="comp-resize comp-rotate inside wsite-image" style="width: 320px; height: 211px; left: 50%;margin-left: -160px; top: 167px; z-index: 3;">
                        <div class="element-box" style="left: 50%;margin-left: -160px; animation: zoomInRoll 2.8s linear 0s 1 both;">
                            <img class="element comp_image editable-image wxuploader" src="<?php echo isset($elements['p3e2']) ?  get_img_url($elements['p3e2']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                    ...
                    <li class="comp-resize comp-rotate inside wsite-image" style="width: 161px; height: 53px; left: 79px; top: 307px; z-index: 4;">
                        <div class="element-box" style="animation: fadeIn 2s ease 0s 1 both;">
                            <img class="element comp_image editable-image " src="<?php echo isset($elements['p3e3']) ?  get_img_url($elements['p3e3']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                            <input type="hidden" name="p3e3" value="<?php echo isset($elements['p3e3']) ?  get_img_url($elements['p3e3']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>" />
                        </div>
                    </li>
                </ul>
            </div>
                ...
                <ul class="edit_area weebly-content-area weebly-area-active">
                    <li class="comp-resize comp-rotate inside wsite-image" style="width: 60%; height: 60%; right: 0; top: 0; z-index: 2;">
                        <div class="element-box" style="animation: fadeInDown 2s ease 1s 1 both;">
                            <img class="element comp_image editable-image wxuploader" src="<?php echo isset($elements['p4e1']) ?  get_img_url($elements['p4e1']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                    ...
                    <li class="comp-resize comp-rotate inside wsite-image" style="width: 40%; height: 30%; left: 0; top: 0; z-index: 3;">
                        <div class="element-box" style="animation: fadeInDown 2s ease 0s 1 both;">
                            <img class="element comp_image editable-image wxuploader" src="<?php echo isset($elements['p4e2']) ?  get_img_url($elements['p4e2']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                    ...
                    <li class="comp-resize comp-rotate inside wsite-image" style="width: 40%; height: 30%; left: 0; top: 30%; z-index: 4;">
                        <div class="element-box" style=" animation: fadeInLeft 2s ease 2s 1 both;">
                            <img class="element comp_image editable-image wxuploader" src="<?php echo isset($elements['p4e3']) ?  get_img_url($elements['p4e3']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                    ...
                    <li class="comp-resize comp-rotate inside wsite-image" style="width: 100%; height: 40%; left: 0; bottom: 0; z-index: 5;">
                        <div class="element-box" style=" animation: fadeInRight 2s ease 2s 1 both;">
                            <img class="element comp_image editable-image wxuploader" src="<?php echo isset($elements['p4e4']) ?  get_img_url($elements['p4e4']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                            <input type="hidden" name="p4e4" value="<?php echo isset($elements['p4e4']) ?  get_img_url($elements['p4e4']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>" />
                        </div>
                    </li>
                </ul>
            </div>
            ...
            <div class="m-img" id="page5">
                <ul class="edit_area weebly-content-area weebly-area-active">
                    ...
                    <li class="comp-resize comp-rotate inside wsite-image inside-hover" style="width: 50%; height: 51%; left: 0; top: 0; z-index: 2;">
                        <div class="element-box" style="animation: fadeInDown 2s ease 0s 1 both;">
                            <img class="element comp_image editable-image wxuploader" src="<?php echo isset($elements['p5e2']) ?  get_img_url($elements['p5e2']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                    ...
                    <li class="comp-resize comp-rotate inside wsite-image" style="width: 50%; height: 49%; right: 0; top: 0; z-index: 3;">
                        <div class="element-box" style="animation: fadeInRight 2s ease 0s 1 both;">
                            <img class="element comp_image editable-image wxuploader" src="<?php echo isset($elements['p5e3']) ?  get_img_url($elements['p5e3']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                            <input type="hidden" name="p5e3" value="<?php echo isset($elements['p5e3']) ?  get_img_url($elements['p5e3']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>" />
                        </div>
                    </li>
                    <li class="comp-resize comp-rotate inside wsite-image" style="width: 50%; height: 49%; left: 0; bottom: 0; z-index: 4;">
                        <div class="element-box" style=" animation: fadeInLeft 2s ease 1s 1 both;">
                            <img class="element comp_image editable-image wxuploader" src="<?php echo isset($elements['p5e4']) ?  get_img_url($elements['p5e4']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                            <input type="hidden" name="p5e4" value="<?php echo isset($elements['p5e4']) ?  get_img_url($elements['p5e4']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>" />
                        </div>
                    </li>
                    <li class="comp-resize comp-rotate inside wsite-image" style="width: 101px; height: 101px; left: 50%; top: 50%;margin: -50px 0 0 -50px; z-index: 5;">
                        <div class="element-box" style="margin: -50px 0 0 -50px;animation: zoomIn 2s ease 2s 1 both;">
                            <img class="element comp_image editable-image" src="<?php echo isset($elements['p5e5']) ?  get_img_url($elements['p5e5']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                            <input type="hidden" name="p5e5" value="<?php echo isset($elements['p5e5']) ?  get_img_url($elements['p5e5']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>" />
                        </div>
                    </li>
                    <li class="comp-resize comp-rotate inside wsite-image" style="width: 93px; height: 60px; left: 50%; top: 50%;margin: -30px 0 0 -46px; z-index: 6;">
                        <div class="element-box" style="margin: -30px 0 0 -46px;animation: fadeIn 2s ease 3s 1 both;">
                            <img class="element comp_image editable-image" src="<?php echo isset($elements['p5e6']) ?  get_img_url($elements['p5e6']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                            <input type="hidden" name="p5e6" value="<?php echo isset($elements['p5e6']) ?  get_img_url($elements['p5e6']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>" />
                        </div>
                    </li>
                </ul>
            </div>
                ...
                <ul class="edit_area weebly-content-area weebly-area-active">
                    <li class="comp-resize comp-rotate inside wsite-image" style="width: 290px; height: 80%; left: 35px; top: 25px; z-index: 2;">
                        <div class="element-box">
                            <img class="element comp_image editable-image wxuploader" data-group="g6" src="<?php echo isset($elements['p6e1']) ?  get_img_url($elements['p6e1']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                    ...
                    <li class="comp-resize comp-rotate inside wsite-image" style="width: 290px; height: 80%; left: 35px; top: 25px; z-index: 3;">
                        <div class="element-box" style="animation: fadeInRight 1s ease 2s 1 both;">
                            <img class="element comp_image editable-image wxuploader" data-group="g6" src="<?php echo isset($elements['p6e2']) ?  get_img_url($elements['p6e2']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                    ...
                    <li class="comp-resize comp-rotate inside wsite-image" style="width: 290px; height: 80%; left: 35px; top: 25px; z-index: 4;">
                        <div class="element-box" style="animation: fadeInRight 1s ease 4s 1 both;">
                            <img class="element comp_image editable-image wxuploader" data-group="g6" src="<?php echo isset($elements['p6e3']) ?  get_img_url($elements['p6e3']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                    ...
                    <li class="comp-resize comp-rotate inside wsite-image" style="width: 290px; height: 80%; left: 35px; top: 25px; z-index: 5;">
                        <div class="element-box" style="animation: fadeInRight 1s ease 6s 1 both;">
                            <img class="element comp_image editable-image wxuploader" data-group="g6" src="<?php echo isset($elements['p6e4']) ?  get_img_url($elements['p6e4']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                    ...
                    <li class="comp-resize comp-rotate inside wsite-image inside-hover" style="width: 100%; height: 100%; left: 0; top: 0px; z-index: 6;">
                        <div class="element-box">
                            <img class="element comp_image editable-image" src="<?php echo isset($elements['p6e5']) ?  get_img_url($elements['p6e5']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                            <input type="hidden" name="p6e5" value="<?php echo isset($elements['p6e5']) ?  get_img_url($elements['p6e5']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>" />
                        </div>
                    </li>
                    <li class="comp-resize comp-rotate inside wsite-image" style="width: 80px; height: 82px; left: 240px; top: 0px; z-index: 7;">
                        <div class="element-box" style=" animation: fadeInDown 2s ease 0s 1 both;">
                            <img class="element comp_image editable-image" src="<?php echo isset($elements['p6e6']) ?  get_img_url($elements['p6e6']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                            <input type="hidden" name="p6e6" value="<?php echo isset($elements['p6e6']) ?  get_img_url($elements['p6e6']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>" />
                        </div>
                    </li>
                    <li class="comp-resize comp-rotate inside wsite-image" style="width: 57px; height: 41px; right: 97px; bottom: 145px; z-index: 8;">
                        <div class="element-box" style="animation: fadeInDown 2s ease 0s 1 both;">
                            <img class="element comp_image editable-image" src="<?php echo isset($elements['p6e7']) ?  get_img_url($elements['p6e7']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                            <input type="hidden" name="p6e7" value="<?php echo isset($elements['p6e7']) ?  get_img_url($elements['p6e7']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>" />
                        </div>
                    </li>
                    <li class="comp-resize comp-rotate inside wsite-image" style="width: 155px; height: 101px; right: 50px; bottom: 65px; z-index: 9;">
                        <div class="element-box" style=" animation: fadeInUp 1s ease 0s 1 both;">
                            <img class="element comp_image editable-image" src="<?php echo isset($elements['p6e8']) ?  get_img_url($elements['p6e8']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                            <input type="hidden" name="p6e8" value="<?php echo isset($elements['p6e8']) ?  get_img_url($elements['p6e8']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>" />
                        </div>
                    </li>
                    <li class="comp-resize comp-rotate inside wsite-image" style="width: 121px; height: 66px; right: 68px; bottom: 80px; z-index: 10;">
                        <div class="element-box" style="animation: fadeIn 2s ease 1s 1 both;">
                            <img class="element comp_image editable-image" src="<?php echo isset($elements['p6e9']) ?  get_img_url($elements['p6e9']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                            <input type="hidden" name="p6e9" value="<?php echo isset($elements['p6e9']) ?  get_img_url($elements['p6e9']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>" />
                        </div>
                    </li>
                </ul>
            </div>
            ...
            <div class="m-img" id="page7">
                <ul class="edit_area weebly-content-area weebly-area-active">
                    <li class="comp-resize comp-rotate inside wsite-image" style="width: 100%; height: 100%; left: 0; top: 0px; z-index: 2;">
                        <div class="element-box" style=" animation: fadeInRight 2s ease 0s 1 both;">
                            <img class="element comp_image editable-image wxuploader" data-group="g7" src="<?php echo isset($elements['p7e1']) ?  get_img_url($elements['p7e1']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                    ...
                    <li class="comp-resize comp-rotate inside wsite-image" style="width: 100%; height: 100%; left: 0; top: 0px; z-index: 3;">
                        <div class="element-box" style=" animation: rollIn 2.5s ease 1.8s 1 both;">
                            <img class="element comp_image editable-image wxuploader" data-group="g7" src="<?php echo isset($elements['p7e2']) ?  get_img_url($elements['p7e2']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
                    ...
                    <li class="comp-resize comp-rotate inside wsite-image" style="width: 100%; height: 100%; left: 0; top: 0px; z-index: 4;">
                        <div class="element-box" style=" animation: puffIn 2.5s ease 3.5s 1 both;">
                            <img class="element comp_image editable-image wxuploader" data-group="g7" src="<?php echo isset($elements['p7e3']) ?  get_img_url($elements['p7e3']['default']) : $domain['static']['url'].'/wap/images/m-bancont.png'?>">
