        ...
        <section class="swiper-slide">  
            <ul>
                ...
                <li class="ani" style="width: 150px; height: 43px; right: 20px; top: 460px;" swiper-animate-effect="zoomIn" swiper-animate-duration="1s" swiper-animate-delay="5s">
                    <a href="tel:tel:<?php echo isset($elements[$page_ids[6]][2]['default']) ?  $elements[$page_ids[6]][2]['default'] : '153xxxx6898'?>"><img src="<?php echo $domain['static']['url']?>/wap/images/model/model13-cont32.png"></a>
                </li>
            </ul>                 
        </section>
        <section class="swiper-slide"> 
            <ul>
                ...
                <li id="message" class="ani" style="width: 157px; height: 45px; right: 20px; top: 80%;" swiper-animate-effect="zoomIn" swiper-animate-duration="1s" swiper-animate-delay="2s">
                    <a href="/h5album/bless/<?php echo $user_info['id']?>"><img src="<?php echo $domain['static']['url']?>/wap/images/model/model13-cont37.png"></a>
                </li>
