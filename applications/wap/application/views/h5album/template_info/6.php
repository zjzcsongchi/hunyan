            ...
            <div class="m-img" id="page9">
                <ul class="edit_area weebly-content-area weebly-area-active">
                    ...
                    <li class="comp-resize comp-rotate inside wsite-text" style="width: 137px; height: 36px; left: 50%;margin-left: -69px; top: 350px; z-index: 19;">
                        <div class="element-box" style="left: 50%;margin-left: -69px;background-color: rgba(255, 255, 255, 0);"><div class="element comp_paragraph editable-text" style="cursor: default; width: 137px; height: 36px;"><font color="#ffffff" style="background-color: rgba(255, 255, 255, 0);" face="minijianxiuying_6391_25">一键导航</font></div></div>
                    </li>
                    <li class="comp-resize comp-rotate inside wsite-image" style="width: 114px; height: 42px; left: 50%;margin-left: -57px; top: 350px; z-index: 20;">
                        <div class="element-box" style="left: 50%;margin-left: -57px;"><img class="element comp_image editable-image" src="<?php echo $domain['static']['url']?>/wap/images/model/model2-cont18.png"></div>
                    </li>
                </ul>
            </div>
        </section>
            ...
            <div class="m-img" id="page10">
                <ul class="edit_area weebly-content-area weebly-area-active">
                    ...
                    <li class="comp-resize comp-rotate inside wsite-image" style="width: 142px; height: 42px; right: 20px; bottom: 100px; z-index: 14;">
                        <div class="element-box" style=" animation: fadeInRight 2s linear 1.5s 1 both;"><img class="element comp_image editable-image" id="message" src="<?php echo $domain['static']['url']?>/wap/images/model/model2-cont21.png"></div>
                    </li>
                </ul>
            </div>
        </section>
