    ...
    <div class="swiper-wrapper">
        ...
        <section class="swiper-slide">   
            <ul>
                ...
                <li id="message" class="ani" style="width: 128px; height: 32px; right: 30px; top: 460px;" swiper-animate-effect="bounceIn" swiper-animate-duration="2s" swiper-animate-delay="1.2s">
                    <img src="<?php echo $domain['static']['url']?>/wap/images/model/model12-cont45.png">
                </li>
