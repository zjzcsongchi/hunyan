<form class="form-horizontal">
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<ul class="nav nav-tabs" role="tablist">
				<li id="system_nav" class="active" data-target="system">
					<a href="#system" data-toggle="tab">选择图标</a>
				</li>
				<li id="customize_nav" data-target="customize">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label">切换到场景</label>
		<div class="col-sm-8">
			<?php foreach($scene as $k => $v):?>
			<div class="radio">
				<label>
					<input type="radio" name="linkedscene" value="<?php echo $v['value'] ?>">
					<img src="<?php echo $v['thumb'] ?>" style="width:20px;height: 20px"><?php echo $v['name'] ?>
				</label>
			</div>
			<?php endforeach; ?>
		</div>
