...
<form class="formbody" method="post" id="form" action="/dishclass/add"> 
    <div id="usual1" class="usual"> 
      	<div id="tab1" class="tabson">
            ...
            <li>
                <label>状态</label>
                <cite>
                    <input type="radio" name="is_del" value="0"  checked="true">正常
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio" name="is_del" value="1"  >删除
                </cite>
			</li>
