...
<form  method="post" id="form">
    ...
    <ul class="forminfo">
        <li><label>真实姓名</label><input name="realname" type="text" class="dfinput" required value="<?php echo $info['realname']?>"/><b>*</b></li>
        <li><label>昵称</label><input name="nickname" type="text" class="dfinput"  value="<?php echo $info['nickname']?>"/><i></i></li>
        <li><label>电话</label><input name="mobile_phone" type="text" class="dfinput" value="<?php echo $info['mobile_phone']?>"/><b>*</b></li>
        <li><label>身份证号</label><input name="id_number" type="text" class="dfinput" value="<?php echo $info['id_number']?>"/></li>
        <li><label>居住地址</label><input name="address" type="text" class="dfinput" value="<?php echo $info['address']?>"/></li>
        <li><label>性别</label><input name="sex" type="radio"  value="1" <?php if($info['sex'] == 1): ?>checked="checked"<?php endif;?> />男
        ...
        <li>
            ...
            <ul id="uploader_img_url">
                ...
                <li class='pic pro_gre' style='margin-right: 20px; clear:none;'>
                    ...
                    <a href="<?php echo $info['head_img'];?>" target="_blank"><img src="<?php echo get_img_url($info['head_img']);?>" style='width:100%;height:100%'/></a>
