    ...
    <div class="page-main">
        ...
        <div class="form">
          <form action="#" method="post" >
        	...
        	<div class="req fix mif" style="line-height:40px;">
        		<ul>
        			<li><p style="font-size:16px ;font-weight: bolder;">主桌</i>：</p></li>
                    ...
                    <?php else:?>
                        ...
                        <li><label><input type="radio" name="zuzhuo" value="1" checked="checked" />需要  </label>
                            (<span> <?php echo $dinner_extend[C('dinner_extend.zuzhuo.id')]['num']?> </span>/个 ) 
                        </li>
                    <?php endif;?>
        		</ul>
        	</div>
        	...
        	<div class="req" style="line-height:40px;">
        		<ul>
                    ...
                    <?php else:?>
                        <li style="margin: 0px 32px;"><label><input type="radio" name="mc" value="0" />不需要</label></li>
            			<li><label><input type="radio" name="mc" value="1" checked="checked" />需要</label>(备注：<span> <?php echo $dinner_extend[C('dinner_extend.mc.id')]['remark']?> </span> )</li>
                    <?php endif;?>
        		</ul>
        	</div>
        	...
        	<div class="req fix" style="line-height:40px;">
        		<ul>
        			...
        			<li><p style="font-size:16px ;font-weight: bolder;">麻 将<i>（10人/席）</i>：<?php echo isset($dinner_extend[C('dinner_extend.mahjong.id')]) ? $dinner_extend[C('dinner_extend.mahjong.id')]['num'] : 0;?></span> 桌</p></li>
        		</ul>
        	</div> 
            ...
            <div class="tb2">
            	<ul>
            		...
            		<li>
            			...
            			<p>现价：<b id="combo_price"><?php echo $combo['price'];?></b> 元 </p>
            		</li>
            		<li class="dic">
            			菜品
            		</li>
