...
-->
    ...
    <div class="row">
        <form class="form-inline">
            ...
            <div class="form-group">
                <label>审核日期：</label>
                <input type="text" name="examine_time" class="form-control Wdate" style="height: 34px;" placeholder="请选择日期" value="<?php if(isset($examine_time)){echo $examine_time;}?>">
            </div>
        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
        		    ...
        		    <td><?php echo isset($v['examine_time']) ? $v['examine_time'] : ''?></td>
                    <?php if ( !isset($is_unusual) ): ?>
