...
define(function(require, exports, module){
	...
	module.exports = {
		...
		add:function(edit_obj){
			var obj = this
			var content = $(add_article);

			layer.create_layer("添加图文热点", content)
			//初始化编辑器
			wangeditor.load();
			//初始化添加图片按钮
			var object = [
		...
		edit:function(edit_obj, hotspot){
               var obj = this
               var content = $(edit_article);
               console.log(hotspot.hotspot_name)
               //数据赋值
               content.find("input[name='id']").val(hotspot.id)
               ...
               content.find("#wang_editor").val(hotspot.article_content)
               ...
               $(".save_layer").click(function(){
                    ...
                    hotspot.article_content = article_content
                    if(dynamic_url){
