...
define(function(require, exports, module){
	...
	module.exports = {
		...
		add:function(edit_obj){
			var obj = this
			var content = $(add_link);

			layer.create_layer("添加链接热点", content)
			var object = [
          	...
          	$(".save_layer").click(function(){
          		...
          		if(is_dynamic){
                    ...
                    var source_url = $("input[name=link]").val()
          		var hotspot_value = {
          			hotspot_type:"link",
		...
		edit:function(edit_obj, hotspot){
               ...
               content.find("input[name=link]").val(hotspot.source_url)

               layer.create_layer("修改链接热点", content)
               //初始化添加图片按钮
               var object = [
                        {"obj":"#uploader_ico", "btn":"#btn_ico"}
                        ];
