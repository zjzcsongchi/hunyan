...
!function(e, t) {
    ...
    O.prototype = {
        ...
        initList: function() {
            ...
            f(e.images, function(a, r) {
                var s = a.src
                 ...
                 o.push('<li><img src="' + s + '" data-is_purchased="' + a.getAttribute('data-is_purchased') + '" data-action="view" data-index="' + r + '" data-original-url="' + (c || s) + '" alt="' + u + '"></li>');
        ...
        view: function(e) {
            ...
            t.setAttribute('data-id', o),
            t.setAttribute('data-is_purchased', n.getAttribute("data-is_purchased")),
